...
<html lang="en">
    ...
    <body>
            ...
            <div class="table-wrapper">
                <div class="table-title card bg-body-tertiary">
                    <div class="form-row d-flex">
                        <div class="col-sm-4"><h2>Admin <b>Details</b></h2></div>
                        <div class="col">
                            <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#newAdmin">New admin</button>
                        </div>
                    </div>
                </div>
                        ...
                        require_once("connect.php");
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    ...
                                    <td>' .$username. '</td>
                                    <td><p>First Name : <b>' .$firstName. '</b></p><p>Last Name : <b>' .$lastName. '</b></p></td>
                                    <td>' .$email. '</td>
                                    <td>' .$phone. '</td>
                                    <td>' .$date. '</td>
                                    <td>
                                        <form action="admin_admin_2.php" method="POST">
                                            <button class="btn btn-sm btn-primary" style="margin-left:35px;" data-toggle="modal" data-target="#editUser' .$id. '" type="button">Edit</button><br>
        ...
        <?php 
            include 'partials/admin_form.php';
        ?>
        <style>
            .table-title {
                color: #fff;
