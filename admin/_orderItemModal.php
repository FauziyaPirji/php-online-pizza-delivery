                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    <th scope="col" class="border-0 bg-light"><div class="px-3">Item</div></th>
                                    <th scope="col" class="border-0 bg-light"><div class="text-center">Quantity</div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $photo = $itemrow['pizzaPhoto'];
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="Images/'.$photo. '" alt="" width="70" class="img-fluid rounded shadow-sm">
